...
public class AdminMapper {
    ...
    public UserDto toDto(StaffUser u) {
        ...
        return new UserDto(u.getId(), u.getUsername(), u.getDisplayName(), u.getEmail(), u.isEnabled(), roles, u.getSupervisorId(), u.getSupervisorDisplayName(), u.isTenantSuperAdmin(), u.isAutoCreateNextDayShift());
    }
}
