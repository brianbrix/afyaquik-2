...
public class PermissionAssignmentDto {
    ...
    public PermissionAssignmentDto() {}

    public PermissionAssignmentDto(Long id, String targetType, Long targetId, String permissionCode, String permissionDescription, String state) {
        this.id = id;
